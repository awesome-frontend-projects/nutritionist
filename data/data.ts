...
export const heroStatItems = [
  {
    imgUrl: "/images/hero-img-1.png",
  },
  {
    imgUrl: "/images/hero-img-2.png",
  },
  {
    imgUrl: "/images/hero-img-3.png",
  },
];
...
export const blogSecItems = [
  ...
  },
  {
    ...
    authorImg: "/images/auth-4.png",
    author: "Emily Johnson",
    date: "23 May 2023 - 5 min read",
  },
];

export const testimonialSecItems = [
  {
    id: 1,
...
export const howItWorkItems = [
  ...
  },
  {
    ...
    text: "Our ultimate goal is to help you develop sustainable lifestyle habits that will support your long-term health and wellness. We will equip you with the knowledge and skills to maintain your progress even after you've completed the program.",
  },
];
...
export const pricingPageSecItems = [
  {
    id: 1,
    title: "Basic Plan",
    subtitle: "Up to 50% off on Yearly Plan",
    texts: [
      {
        text: "Personalized nutrition plan tailored to your goals and dietary preferences.",
      },
      {
        text: "Access to our mobile app for convenient meal tracking and progress monitoring.",
      },
      {
        text: "Email support to address your questions and concerns.",
      },
      {
        text: "Regular check-ins with a dedicated nutritionist to review your progress and provide guidance.",
      },
    ],
    price: 49,
  },
  {
    ...
    texts: [
      {
        text: "All the features included in the Basic Plan.",
      },
      {
        text: "One-on-one video consultations with your dedicated nutritionist for more personalized guidance and support.",
      },
      {
        text: "Recipe recommendations and meal planning assistance.",
      },
      {
        text: "Priority email support for quicker responses to your inquiries.",
      },
      {
        text: "Educational resources and guides to deepen your understanding of nutrition and healthy habits.",
      },
    ],
    price: 79,
  },
  {
    ...
    texts: [
      {
        text: "All the features included in the Plus Plan.",
      },
      {
        text: "Unlimited access to video consultations with your dedicated nutritionist for ongoing support and accountability.",
      },
      {
        text: "Advanced progress tracking tools to monitor your weight, body measurements, and fitness goals.",
      },
      {
        text: "Customized meal plans and recipe suggestions based on your preferences and nutritional needs.",
      },
      {
        text: "Priority email and phone support for immediate assistance.",
      },
    ],
    price: 99,
  },
...
export const pricingTable: PricingTableData = {
  titles: ["Features", "Basic Plan", "Premium Plan", "Ultimate Plan"],
  rows: [
    {
      feature: "Personalized Nutrition Plan",
      availability: [true, true, true],
    },
    { feature: "Mobile App Access", availability: [true, true, true] },
    { feature: "Email Support", availability: [true, true, true] },
    {
      feature: "One-on-One Video Consultations",
      availability: [false, true, true],
    },
    {
      feature: "Recipe Recommendations and Meal Planning",
      availability: [false, true, true],
    },
    { feature: "Priority Support", availability: [false, true, true] },
    {
      feature: "Educational Resources and Guides",
      availability: [false, true, true],
    },
    {
      feature: "Advanced Progress Tracking Tools",
      availability: [false, false, true],
    },
    {
      feature: "Customized Meal Plans and Recipe Suggestions",
      availability: [false, false, true],
    },
    { feature: "Phone Support", availability: [false, false, true] },
  ],
};
...
export const questionItems = [
  {
    ...
    text: "Personalized nutrition coaching involves creating a customized nutrition plan based on your unique goals, preferences, and dietary requirements. Our team of experts will work closely with you to develop a plan that fits your lifestyle and helps you achieve optimal health and wellness.",
  },
  {
    id: 2,
